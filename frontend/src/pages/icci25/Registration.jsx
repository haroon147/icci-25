...
import { Users, CreditCard, CheckCircle, ExternalLink, Lock } from 'lucide-react';
        ...
        <div className="container-custom relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-body text-white/90 content-container-md text-content-center text-break">
              ICCI-2025 took place December 8–9, 2025. Registration for this edition is now closed.
            </p>
          </div>
        </div>
      </section>
